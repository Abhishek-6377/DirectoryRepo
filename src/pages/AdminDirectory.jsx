    ...
    <div className="relative min-h-screen bg-[#FFF3F1] overflow-x-hidden">
      <section className="top-space-padding mt-12 pb-0 relative z-10">
        ...
        <div className="relative z-10 p-6 md:px-8 mx-auto">
          <h1 className="text-3xl text-center font-bold text-black mb-6">Member Admin Directory</h1>
          ...
          <div className="space-y-4">
            {data.map((person, index) => (
              ...
              >
                ...
                <p>{person.city || "N/A"}</p>
                <a href={`https://wa.me/${encodeURIComponent(person.whatsapp || "")}?text=Hello%20${encodeURIComponent(person.name || "")}%20from%20${encodeURIComponent(person.company || "")}%20👋`} target="_blank" rel="noopener noreferrer" className="bg-green-600 text-white px-2 py-1 rounded hover:bg-green-500 text-center">
                  <FaWhatsapp className="inline mr-1" />{person.whatsapp || "N/A"}
                </a>
